...
| Live GitLab pipeline | Runner registered and custom driver hooks repaired/verified; guest provisioning remains pending. Test-project pipeline committed locally; host iOS build passed. No live pipeline yet. |
